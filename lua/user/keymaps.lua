...
map("n", "<Leader>e", ":Fern . -reveal=%<CR>", { noremap = true, silent = true })
...
-- Telescope
map("n", "<Leader>ff", ":Telescope find_files previewer=false theme=dropdown disable_devicons=true<CR>", { noremap = true, silent = true })
...
-- Harpoon
map("n", "<Leader>jj", ":lua require('harpoon.ui').toggle_quick_menu()<CR>", { noremap = true, silent = true })
map("n", "<Leader>hh", ":lua require('harpoon.mark').add_file()<CR>", { noremap = true, silent = true })
